...
var livesearch = (function () {
    ...
    function _searchfactory($form, $inputnode) {
        ...
        //GW4 - permetem canviar la url del cercador per poder triar entre
        // la cerca a (intranet) o la cerca a upc.edu
        function _set_target($target){
            $querytarget = $target.replace(/search$/g,"") + "livesearch_reply"
        }
        ...
        // GW4 permetem cridar a la nostra funció set_target
        return {
            hide: _hide,
    ...
    //GW4 - permete que es pugui cridar a set_target de manera individual
    return {
        search: function(id) {
        ...
        set_target: function(id, url){
          _search_handlers['livesearch'+id].set_target(url);
        }
    };
}());
